...
void Game::drawEnemies() const
{
    ...
    case Difficulty::Easy:
        maxHPLevel = (currentLevel == 1) ? 60 : (currentLevel == 2) ? 80
                                                                    : 100;
        break;
    case Difficulty::Medium:
        maxHPLevel = (currentLevel == 1) ? 70 : (currentLevel == 2) ? 90
                                                                    : 110;
        break;
...
void Game::spawnEnemiesForLevel()
{
    ...
    case Difficulty::Easy:
        ...
        hpForLevel = (currentLevel == 1) ? 60 : (currentLevel == 2) ? 80
                                                                    : 100;
        break;
    case Difficulty::Medium:
        // Medio: vida intermedia (70, 90, 110)
        hpForLevel = (currentLevel == 1) ? 70 : (currentLevel == 2) ? 90
                                                                    : 110;
        break;
    case Difficulty::Hard:
    default:
